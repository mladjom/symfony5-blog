            ...
            jtd.addEvent(searchInput, 'keyup', function (e) {
                ...
                if (results.length > 0) {
                    ...
                    for (var i in results) {
                        ...
                        var resultRelDate = document.createElement('span');
                        resultRelDate.classList.add('search-result-rel-date');
                        resultRelDate.innerText = doc.date;
                        resultTitle.appendChild(resultRelDate);
